...
def paired_end_files(dictionary_name_1, dictionary_name_2, subsample_max):
    if subsample_max != None: 
...
if args.subsample == None:
    ...
    if subsample_max == 0:
        subsample_max_2 = len(subsample_max_IDs_2)
        logging.info(f'Total amount of reads in the file: {subsample_max_2}')
    else:
        if subsample_max != 0:
